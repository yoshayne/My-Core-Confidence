...
export default function Player() {
  ...
  return (
    <div className="min-h-screen bg-bg pb-10">
      <div className="relative aspect-video w-full bg-black lg:mx-auto lg:max-w-5xl lg:mt-6 lg:overflow-hidden lg:rounded-card">
      ...
      <div className="mx-auto max-w-md px-4 pt-4 lg:max-w-5xl lg:px-0 lg:pt-6">
        <div className="lg:flex lg:gap-8">
          <div className="lg:flex-1">
            <h1 className="text-xl font-bold lg:text-2xl">{workout.title}</h1>
            ...
            <div className="mt-4 flex gap-3">
              <button
                ...
                className="flex flex-1 items-center justify-center gap-2 rounded-button bg-blue py-3 text-sm font-semibold text-white disabled:opacity-60 lg:flex-none lg:px-8"
              >
